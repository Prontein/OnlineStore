package ru.geekbrains.web.core.paypal;
...
public class PayPalService {
    ...
    public OrderRequest createOrderRequest(Long orderId) {
        ru.geekbrains.web.core.model.Order order = orderService.findById(orderId).orElseThrow(() -> new ResourceNotFoundException("Order not found"));
